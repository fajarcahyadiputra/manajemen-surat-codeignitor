...
<body style="">
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				<span class="navbar-brand"><strong style="font-family: verdana;">MANAJEMEN SURAT</strong></span>
			...
			<div class="navbar-collapse collapse" id="navbar-main">
				<ul class="nav navbar-nav">
					...
					<?php } ?>
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="icon-file icon-white"> </i> Report <span class="caret"></span></a>
						<ul class="dropdown-menu" aria-labelledby="themes">
	...
	<div class="container">
			...
			<div class="row">
				<div class="" style="padding: 15px 15px 0 15px;">
					<div class="well well-sm">
						<img src="<?= base_url("aset/img/logotelagaasih.png") ?>" class="thumbnail span3" style="display: inline; float: left; margin-right: 20px; width: 100px; height: 100px">
		...
		<div class="span12 well well-sm">
			<h4 style="font-weight: bold">MANAJEMEN SURAT <a href="#">KELURAHAN TELAGA ASIH</a></a></h4>
