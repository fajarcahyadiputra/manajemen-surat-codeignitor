...
class Admin extends CI_Controller {
	...
	public function surat_masuk() {
		...
		if ($mau_ke == "del") {
			...
			$a['data']		= $this->db->query("SELECT a.*, b.nama FROM t_surat_masuk a INNER JOIN t_admin b ON a.pengolah = b.id WHERE YEAR(a.tgl_diterima) = '$ta' ORDER BY a.id DESC LIMIT $awal, $akhir ")->result();
			$a['page']		= "l_surat_masuk";
		}
	...
	public function surat_keluar() {
		...
		if ($mau_ke == "del") {
			...
			$a['data']		= $this->db->query("SELECT a.*, b.nama FROM t_surat_keluar a INNER JOIN t_admin b ON a.pengolah = b.id WHERE YEAR(a.tgl_catat) = '$ta' ORDER BY a.id DESC LIMIT $awal, $akhir ")->result();
			$a['page']		= "l_surat_keluar";
		}
